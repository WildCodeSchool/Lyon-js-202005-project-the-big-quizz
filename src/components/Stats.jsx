...
function Stats(props) {
  ...
  let testQuiz = [
    {
      ...
      difficulty: "medium",
      incorrect_answers: ["Heavy Crossbow", "Thanatos .50 cal", "Broomstick Pistol"],
      ...
      difficulty: "easy",
      incorrect_answers: ["Donald Draper", "John Ashbury", 'Michael "Mikey" Wilhelm'],
  ...
  let testScores = [
    [[0, true, 0, 8], [6, false, 1, 8], [12, true, 0, 7],[18, true, 0, 7]],
    [[1, true, 0, 10], [7, true, 0, 15], [13, false, 2, 5],[19, true, 0, 7]],
    [[2, true, 0, 8], [8, false, 1, 8], [14, true, 0, 7],[20, true, 0, 7]],
    [[3, true, 0, 10], [9, true, 0, 15], [15, false, 2, 5],[21, true, 0, 7]],
    [[4, false, 1, 8], [10, false, 1, 8], [16, false, 1, 7],[22, false, 0, 7]],
    [[5, true, 0, 10], [11, true, 0, 15], [17, true, 0, 5],[23, true, 0, 7]],
  ];
  ...
  return (
    <div>
      <h1>Stats</h1>
     <p>
       { testScores.map((player,i)=> (<div>player {i+1} : {player.map(question=>(<p>{question}</p>))}</div>))}
       </p>
